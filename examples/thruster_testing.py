...
def main():
    ...
    print("Max force: {0:.2f} kN\t Min force: {1:.2f} kN"
          .format(max_force, min_force))
    ...
    thrust_reduction_ratio = tti.abs_inline_tandem_condition(7.0, 3.0)
    print("In line tandem condition (ABS), t = {0:.2f}"
          .format(thrust_reduction_ratio))
